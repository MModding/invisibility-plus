...
mmodding {
	configureFabricModJson {
		...
		withContact {
			...
			sources = "https://github.com/MModding/invisibility-plus/issues"
			issues = "https://github.com/MModding/invisibility-plus"
		}
		environment = EnvironmentTarget.ANY
		withEntrypoints {
			init("com.mmodding.invisibility.plus.InvisibilityPlus")
		}
